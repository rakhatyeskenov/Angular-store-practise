...
@Component({
  selector: "app-product-list-third",
  templateUrl: "./product-list-third.component.html",
  styleUrls: ["./product-list-third.component.css"]
})
export class ProductListThirdComponent {
  products = products;
  @Input() task: Task;
  cnt:number = 0;
  ...
  removeProduct(index: number) {
    this.productsThirdCategory = this.productsThirdCategory.filter((x) => x.id !== index); 
  }
